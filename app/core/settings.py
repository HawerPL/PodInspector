...
class Settings(BaseSettings):
    ...
    enable_error_mode_log: bool = os.getenv(
        "ENABLE_ERROR_MODE_LOG", False
    )
    enable_error_mode_exception: bool = os.getenv(
        "ENABLE_ERROR_MODE_EXCEPTION", False
    )
    ...
    enable_error_mode_sigkill: bool = os.getenv(
        "ENABLE_ERROR_MODE_SIGKILL", False
    )
    failure_delay_max_minutes: bool = os.getenv(
